...
//    private Dinosaur Dinosaur;
    ...
    private List<Obstacle> list2 = new ArrayList<Obstacle>();//蘑菇集合
    ...
    private void paintImage() {
        ...
        g2.drawImage(background.mg, 270, 16, this);// 绘制金币图标
        ...
        for (int i = 0; i < list.size(); i++) {// 遍历障碍集合
            ...
            if (o.isLive()) {// 如果是有效障碍
                o.move();// 障碍移动
                g2.drawImage(o.image, o.x, o.y-10, this);// 绘制障碍
                g2.drawImage(o.image1, o.x, o.y-60, this);// 绘制障碍
                // 如果恐龙头脚碰到障碍
      ...
      Math math;
		//地面蘑菇集合添加内容
      	if (mgNum >= Math.random()*10000+1) {// 计算蘑菇数量判断
      		list2.add(new Obstacle());//每50ms往金币集合里添加一个蘑菇
